...
#64 bit only
COIN_TGZ='https://github.com/fdreserve/fdr-blockchain/releases/download/V2.3.0/2021-03-15_FDReserve_V230_Aarch64.zip'
#COIN_PATHPART='fdr-v2.3.0-linux/bin'
...
apt-get install -y unzip curl systemd net-tools figlet htop wget
if [ "$?" -gt "0" ];
  then
